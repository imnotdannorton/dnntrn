  ...
  <template>
    <div class="welcome">
      ...
      <p>Over my nearly 10 years of experience in Interactive Design and Development, I have helped build ad campaigns, billboards, content management systems, mini-games, and flagship sites.</p> 
      ...
      <p>My sharpened front-end skills led me to <a href="http://www.spartan.com" target="_blank">Spartan Race,</a> an international Obstacle Course Race company where I am currently the in-house Web Lead. My days are spent building UI elements, extending API endpoints, and writing integrations.  When I'm not sitting in front of a computer, I am most likely hanging out with my wife and cat, or talking about drums somewhere.</p> 
    </div>
  </template>
